from PythonSim.humanAction import HumanActivity
...
class HumanFactory():
    def createActivity(self, humanType):
        if humanType == "Captive":
            ...
            #China harvests ~25 million tons of bamboo a year
            ...
            return HumanActivity(1.2*(10**6)/365, 6/365/100)
        elif humanType == "Act":
            #Humans cut back on deforestation by ~50%
            #Humans pull back from global temperature rise to lower bound value
            return HumanActivity(1.2*(10**6)/365/2, 2/365/100)
